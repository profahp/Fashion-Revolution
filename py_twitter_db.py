...
class TwitterDB:
    ...
    def search7dayapi(
        ...
        aut = OAuth1(OAUTH_CONSUMER_KEY, OAUTH_CONSUMER_SECRET, OAUTH_ACCESS_TOKEN, OAUTH_ACCESS_TOKEN_SECRET)
        
        endpoint = 'https://api.twitter.com/2/tweets.json?q=' + query + '&count=' + max_count + '&lang=' + lang + '&include_entities=true&tweet_mode=extended&result_type=' + result_type + ''
    ...
    def searchPremiumAPI(self, 
        ...
        endpoint = "https://api.twitter.com/2/tweets/search/all" + api_name + "/" + dev_environment
    ...
    def create_bat_file_apisearch(self, 
        ...
        f.write("aut = OAuth1(" + "'" + OAUTH_CONSUMER_KEY + "'" + ","  + "'" + OAUTH_CONSUMER_SECRET  + "'" + ","  + "'" + OAUTH_ACCESS_TOKEN + "'" + ","  + "'" + OAUTH_ACCESS_TOKEN_SECRET  + "'" + ")\n")
        f.write("\n")
